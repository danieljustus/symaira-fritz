...
pub use capabilities::{
    ...
    DiagnoseOptions, Diagnosis, DslLineStats, ErrorKind, Host, LogEvent, MAX_TABLE_ENTRIES,
    MESH_RESPONSE_LIMIT, MeshInterface, MeshLink, MeshNode, MeshTopology, PortProbe, Radio,
    ResolveHostInfo, Status, StatusError, StatusFailure, TrafficData, WLANClient, WLANHost,
    WlanClient, all_public, classify_resolved_host, default_probes, dial_ssh, dial_tcp, error_kind,
    is_private_ip, parse_linux_default_gateway, parse_mesh_topology, parse_windows_default_gateway,
    probe_tr064,
};
pub use client::{
