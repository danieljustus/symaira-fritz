...
| DISC-002 | Discovery URL safety | public host, malformed URL and adversarial control URLs | Go DNS/safe-URL tests | local-router policy, SSRF/path restrictions and redacted diagnostics | concrete HTTP adapter suite | all | semantic | PENDING |
